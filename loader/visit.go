...
type TypeCallback func(file *ast.File, decl *ast.GenDecl, spec *ast.TypeSpec, funcDecl *ast.FuncDecl)
...
func (v *typeVisitor) Visit(node ast.Node) ast.Visitor {
	...
	case *ast.GenDecl:
		...
		return v
	case *ast.TypeSpec:
		v.callback(v.file, v.decl, typedNode, nil)
		return nil // don't recurse
	case *ast.FuncDecl:
		v.callback(v.file, nil, nil, typedNode)
		return nil
	default:
		return nil
	}
